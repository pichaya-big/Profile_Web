...
const PROJECTS = [
  ...
  },
  {
    ...
    description:
      'KraiJai (literally translating from Thai as "Who pays?") is a web application designed for group expense sharing and bill splitting during trips, shared meals, or group events.',
    color: 'from-[#d5bffe] to-[#cae6ff]',
    accent: '#67558c',
    github: 'https://github.com/pichaya-big/KraiJai',
    live: 'https://kraijai.pichaya.dev/',
    featured: false,
  },
  {
    id: 'proj-6',
    ...
    accent: '#006e20',
    github: 'https://github.com/pichaya-big/Profile_Web',
    live: 'https://pichaya.dev/',
    featured: false,
  },
];
